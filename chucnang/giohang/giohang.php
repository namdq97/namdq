...
<div id="cart">
        ...
        <tbody>
            <tr>
                ...
                <td class="actions" data-th="">
                 <a href="chucnang/giohang/xoahang.php?id_sp=<?php echo $row['id_sp'];?>">Xóa</a></button                              
                </td>
            </tr>
        </tbody>
        <?php
        ...
        <tfoot>
            ...
            <tr>
                ...
                <td colspan="2" class="hidden-xs">
                 <a class="btn btn-danger" href="chucnang/giohang/xoahang.php?id_sp=0"> Xóa hết </a> 
                </td>
    ...
    <?php
        ...
        echo '<script>alert("Ko có sản phẩm nào trong giỏ hàng"); </script>';
    }
    ?>
</div>
