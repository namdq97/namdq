...
// Danh sách Sản phẩm đã mua
    ...
    <b><br />Cám ơn Quý khách đã sử dụng Sản phẩm của Công ty chúng Tôi!</b>
        ...
        // Phải chỉnh sửa lại
        $mailer->Username = "arsnam98@gmail.com"; // GMAIL username
        $mailer->Password = "*caothutq*"; // GMAIL password
        $mailer->AddAddress($email, $ten); //email người nhận, $email và $ten là 2 biến đc gán bởi $_POST lấy từ trong form
        $mailer->AddCC("quangnam33@gmail.com", "Admin Vietpro Shop"); // gửi thêm một email cho Admin
        // Chuẩn bị gửi thư nào
        $mailer->FromName = 'Nammm'; // tên người gửi
        $mailer->From = 'arsnam98@gmail.com'; // mail người gửi
        $mailer->Subject = 'Hóa đơn xác nhận mua hàng';
        $mailer->IsHTML(TRUE); //Bật HTML không thích thì false
        // Nội dung lá thư
        $mailer->Body = $strBody;
        // Send mail
        if($mailer->Send()){
            // gui ko dc -> thong bao loi
            echo "Lỗi gửi email";
