<script>
    function xoaSanPham() {
        var conf = confirm('Bạn có muốn xóa sản phảm');
        return conf;
    }
</script>
<?php
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">					
            <div class="panel-body" style="position: relative;">
                <a href="quantri.php?page_layout=themsp" class="btn btn-danger" style="margin: 10px 0 20px 0; position: absolute;">Thêm sản phẩm mới</a>				
                    ...
                    <tbody>
                            ...
                            <tr style="height: 300px;">
                                ...
                                <td data-sortable="true">
                                    <span class="thumb"><img width="90px" height="150px" src="anh/<?php echo $row['anh_sp']; ?>" /></span>
