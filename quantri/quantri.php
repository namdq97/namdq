...
//    if($_SESSION['email']=="nam@gmail.com"){
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="quantri.php"><span>Admin</span></a>
                    <ul class="user-menu">
...
<!--                                <li><a href="#"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg> Thông tin thành viên</a></li>
        ...
        <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
            <a href="quantri.php?page_layout=gioithieu">  <img src="a.jpg" width="100%" height="100px"></a>
<!--            <form role="search">
